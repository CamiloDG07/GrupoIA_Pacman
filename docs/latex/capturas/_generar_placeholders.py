...
SLOTS = [
    ...
    dict(
        ...
        archivo="pacman/searchAgents.py", lineas_rango="273-309",
        funcion="getStartState / isGoalState / getSuccessors, parte 1 de 2 (CornersProblem)",
        codigo_lineas=[
            ...
            "  for action in [...]:",
            "    ... # figurar si la nueva posicion choca con una pared",
        ],
        nota="Parte 1 de 2: el par (posicion, esquinas_visitadas) como estado, y el inicio de getSuccessors.",
    ),
    dict(
        nombre_archivo="actividad07_corners2.png",
        archivo="pacman/searchAgents.py", lineas_rango="309-336",
        funcion="getSuccessors, parte 2 de 2 (CornersProblem)",
        codigo_lineas=[
            "    if not hitsWall:",
        ...
        nota="Parte 2 de 2: construccion del sucesor (nueva posicion, esquinas_visitadas actualizado).",
    ),
    dict(
    ...
    dict(
        nombre_archivo="actividad11_heuristica2_parte1.png",
        archivo="pacman/searchAgents.py", lineas_rango="465-488",
        funcion="foodHeuristic (parte 1 de 2, con cache)",
        codigo_lineas=[
        ...
        nota="Parte 1 de 2: construccion del cache (una sola vez por busqueda). Resaltar el 'if foodPairDistances not in heuristicInfo'.",
    ),
    dict(
        nombre_archivo="actividad11_heuristica2_parte2.png",
        archivo="pacman/searchAgents.py", lineas_rango="490-502",
        funcion="foodHeuristic (parte 2 de 2, con cache)",
        codigo_lineas=[
        ...
        nota="Parte 2 de 2: uso del cache ya calculado para obtener el diametro Manhattan (maxDist).",
    ),
]
