...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{capturas/actividad05_manhattan.png}
\caption{\texttt{manhattanHeuristic} en \texttt{pacman/searchAgents.py} (líneas 236-240).}
\label{fig:act05-manhattan}
\end{figure}
...
(ver \texttt{demo\_actividad5()} en \texttt{pacman/searchAgents.py}). En vez de una interfaz gráfica (no disponible
