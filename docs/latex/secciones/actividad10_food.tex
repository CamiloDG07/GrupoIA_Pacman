...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{capturas/actividad10_food_isgoal.png}
\caption{Estado y \texttt{isGoalState} de \texttt{FoodSearchProblem} en
\texttt{pacman/searchAgents.py} (líneas 396-417).}
\label{fig:act10-food}
\end{figure}
...
\texttt{testClassic} (ver \texttt{demo\_actividad10()} en \texttt{pacman/searchAgents.py}), replicando la
