...
Actividad 7 (ver el hallazgo sobre \texttt{mediumCorners} en esa seccion). El script
\texttt{experimentos/actividad9\_corners\_comparacion.py} corre las cuatro por separado (cada una
