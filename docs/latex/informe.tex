...
{\fontsize{12}{14}\selectfont Camilo Díaz}\\[0.1cm]
{\fontsize{12}{14}\selectfont Juan David}\\[0.1cm]
{\fontsize{12}{14}\selectfont Mario}\\[0.3cm]
...
\input{secciones/actividad01_exploracion.tex}

\section{Actividad 2. Búsqueda de costo uniforme}
\input{secciones/actividad02_ucs.tex}

\section{Actividad 3. Implementación de A*}
\input{secciones/actividad03_astar.tex}

\section{Actividad 4. A* sin información}
\input{secciones/actividad04_astar_nulo.tex}

\section{Actividad 5. A* con distancia Manhattan}
\input{secciones/actividad05_manhattan.tex}

\section{Actividad 6. Distancia Euclidiana}
\input{secciones/actividad06_euclidiana.tex}

\section{Actividad 7. Problema de las cuatro esquinas}
\input{secciones/actividad07_corners.tex}

\section{Actividad 8. Heurística para las esquinas}
\input{secciones/actividad08_corners_heuristica.tex}

\section{Actividad 9. Experimento comparativo (esquinas)}
\input{secciones/actividad09_corners_comparacion.tex}

\section{Actividad 10. Búsqueda de todos los alimentos}
\input{secciones/actividad10_food.tex}

\section{Actividad 11. Diseño de heurísticas para la búsqueda de alimentos}
\input{secciones/actividad11_food_heuristic.tex}

\section{Conclusiones}
\input{secciones/99_conclusiones.tex}
